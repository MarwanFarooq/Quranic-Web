...
>("userdataAddInOwnList", async (arg, AsyncThunk) => {
  ...
  try {
    const info = await axios({
      method: "patch",
      url: `http://localhost:3000/users/${arg.IDUser}`,
      data: {
        PlayList: {
          ...arg.UserPlayLIst,
          [arg.Title]: {
            Title: arg.Title,
            Description: arg.Description,
            data: [...arg.UserPlayLIst[arg.Title].data, arg.Ayhah],
          },
        },
      },
    });
