  ...
  return (
    <div id="backgroundcolor">
      ...
      >
        <GridItem area={"nav"}>
          <div
            className={` mobile:hidden tablet:block sticky overflow-x-hidden overflow-y-scroll bg-black top-[4em] ${isLoading ? "w-[60%]" : ""
              } `}
          >
            ...
            <div className="  mobile:!block tablet:!hidden ">
              <InputGroup className="flex justify-center" >
                <Input
                  ...
                  htmlSize={20}
                  width="auto"
                  placeholder={`${language === "ar" ? "ابحث عن قاري" : " Search reciters ?"
                    }`}
                />
              </InputGroup>
            </div>
