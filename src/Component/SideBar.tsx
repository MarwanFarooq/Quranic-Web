...
import { PlayList, shiftLAstPlayed, UnshiftLastPlayed } from "../ReduxSystem/userSlice";
...
const SideBar = ({ isLoading }: { isLoading: boolean }) => {
  ...
  return (
    <div className="">
      {isLoading ? (
        <Card className=" h-screen you own Playlisteen !bg-black !mobile:hidden !tablet:block w-[30rem]  !rounded-none  p-4">
              ...
              <div>
                ...
                <div className="flex flex-col justify-between h-[70vh]">
                  <div>
                    ...
                    <div className="overflow-x-scroll h-40">
                      <ModelComponent />

                      <div
                        onClick={() => navigition(`/profile/:${id}`)}
                        className="p-4 bg-[#1F1F1F] text-white hover:bg-[#3E3C3C] cursor-pointer flex justify-between ">
                        <h1>
                          See All
                        </h1>
                    ...
                    <div className="flex flex-col p-3 h-[20vh] ">
                      <h1 className="text-white"> {language === "en" ? "Recently PLayed" : "استماع مواخرا"}</h1>
                      <div className="">
                        {UserObject?.map(
                          (
                            {
